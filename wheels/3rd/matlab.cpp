...
namespace wheels {
    ...
    mxArray * matlab_mxarray::mxa() const {
        return _m;
    }
    ...
    bool matlab_mxarray::is_function_handle() const { return mxIsFunctionHandle(_m); }
    ...
    size_t matlab_mxarray::m() const {
        return mxGetM(_m);
    }

    size_t matlab_mxarray::n() const {
        return mxGetN(_m);
    }

    void matlab_mxarray::set_m(size_t m) {
        mxSetM(_m, m);
    }

    void matlab_mxarray::set_n(size_t n) {
        mxSetN(_m, n);
    }

    bool matlab_mxarray::empty() const {
        return mxIsEmpty(_m);
    }
    ...
    size_t matlab_mxarray::numel() const {
        return mxGetNumberOfElements(_m);
    }
    ...
    matlab_mxarray matlab_mxarray::cell(size_t i) const {
        return mxGetCell(_m, i);
    }
    ...
    int matlab_mxarray::nfields() const {
        return mxGetNumberOfFields(_m);
    }
    ...
    void matlab_mxarray::set_field(const std::string & name, const matlab_mxarray & a, int i) const {
        mxSetField(_m, i, name.c_str(), a._m);
    }

    matlab_mxarray matlab_mxarray::property(const std::string & name, size_t i) const {
        return mxGetProperty(_m, i, name.c_str());
    }

    void matlab_mxarray::set_property(const std::string & name, int i, const matlab_mxarray & a) {
        mxSetProperty(_m, i, name.c_str(), a._m);
    }

    const char * matlab_mxarray::class_name() const {
        return mxGetClassName(_m);
    }

    size_t matlab_mxarray::ndims() const {
        return mxGetNumberOfDimensions(_m);
    }
    ...
    size_t matlab_mxarray::dim(size_t d) const {
        return mxGetDimensions(_m)[d];
    }
    ...
    void * matlab_mxarray::real_data() const {
        return mxGetData(_m);
    }

    void * matlab_mxarray::imag_data() const {
        return mxGetImagData(_m);
    }
    ...
    matlab_matfile::matlab_matfile(const std::string & fname, const std::string & mode) : _fname(fname) {
        _fp = matOpen(fname.c_str(), mode.c_str());
    }
    matlab_matfile::matlab_matfile(const std::string & fname, OpeningMode mode) : _fname(fname), _fp(nullptr) {
        std::string m;
        switch (mode) {
        case Read:
            m = "r";
    ...
    bool matlab_matfile::set_var(const std::string & name, const matlab_mxarray & mxa, bool asGlobal /*= false*/) {
        if (!asGlobal) {
    ...
    matlab_engine::matlab_engine(const std::string & defaultDir, bool singleUse) : _eng(nullptr), _buffer(nullptr) {
    ...
    bool matlab_engine::started() const {
        return _eng != nullptr;
    }
    ...
    std::string matlab_engine::last_message() const {
        return _buffer;
    }
    ...
    matlab_mxarray matlab_engine::var(const std::string & name) const {
        return matlab_mxarray(engGetVariable(static_cast<::Engine*>(_eng), name.c_str()), true);
    }

    bool matlab_engine::set_var(const std::string & name, const matlab_mxarray & mxa) {
