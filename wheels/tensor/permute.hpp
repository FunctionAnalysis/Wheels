...
template <class ShapeT, class ET, class T, class E, class ReduceT,
          size_t... Inds>
constexpr E reduce_elements(const permute_result<ShapeT, ET, T, Inds...> &t,
...
// norm_squared
template <class ShapeT, class ET, class T, size_t... Inds>
constexpr auto norm_squared(const permute_result<ShapeT, ET, T, Inds...> &t) {
...
namespace details {
template <class ShapeT, class ET, class T, size_t... Inds>
constexpr permute_result<ShapeT, ET, T, Inds...> &&
_simplify_permute_impl(permute_result<ShapeT, ET, T, Inds...> &&p,
                       no simplifiable) {
  return static_cast<permute_result<ShapeT, ET, T, Inds...> &&>(p);
}
template <class ShapeT, class ET, class T, size_t... Inds>
constexpr T _simplify_permute_impl(permute_result<ShapeT, ET, T, Inds...> &&p,
                                   yes simplifiable) {
...
constexpr auto
permute(const permute_result<ShapeT, ET, T, Inds...> &t, const IndexTs &...) {
